...
import com.yoga.book.exception.OperationNotPermittedException;
import com.yoga.book.file.FileStorageService;
import com.yoga.book.history.BookTransactionHistoryRepository;
...
import static com.yoga.book.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public BookResponse findById(Integer bookId) {
        return bookRepository.findById(bookId)
                ...
                .orElseThrow(()-> new EntityNotFoundException("No booking found with ID : " + bookId));
    }
    ...
    public Integer updateShareableStatus(Integer bookId, Authentication connectedUser) {
        Book book = bookRepository.findById(bookId)
                .orElseThrow(()->
                        new EntityNotFoundException("No booking found with ID: " + bookId));
        User user = ((User) connectedUser.getPrincipal());
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException(" be borrowed since it is archived or not shareable.");
        }
        User user = ((User) connectedUser.getPrincipal());
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
